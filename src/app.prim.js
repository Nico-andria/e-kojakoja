...
function App() {
  ...
  // Fonction pour déterminer le texte à afficher
  const getEnvoiLabel = (envoi) => {
    switch (envoi) {
      case "Maritime":
        return "Maritime";
      case "Maritime -0,15m³":
        return "Maritime -0,15m³";
      case "Maritime ML":
        return "Maritime Marchandise Lourde";
      case "Air Normal":
        return "Air Normal";
      case "Air Normal BAT":
        return "Air Normal avec batterie";
      case "Air Normal P/L":
        return "Air Normal Poudre/Liquide";
      case "Air Express":
        return "Air Express";
      case "Air Express BAT":
        return "Air Express avec batterie";
      case "Air Express P/L":
        return "Air Express Poudre/Liquide";

      // Ajoutez d'autres cas si nécessaire
      default:
        return envoi; // Affiche la valeur par défaut si aucune condition n'est remplie
    }
  };
